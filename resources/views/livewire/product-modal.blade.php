            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <input type="file" accept="image/*" id="image" name="product_image"
                        class="form-control @error('product_image') is-invalid @enderror" onchange="previewImage();">
                    ...
                    <div class="row row-cards">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="number" id="sale_price" name="sale_price" step="0.01"
                                    ...
                                    placeholder="Sale Price" value="{{ old('sale_price', $product->sale_price) }}">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="number" id="whole_sale_price" name="whole_sale_price" step="0.01"
